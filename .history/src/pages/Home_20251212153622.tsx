                    ...
                    <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
                        <div>
                            ...
                            <h1 className="mt-4 text-4xl font-bold tracking-tight text-heading sm:text-5xl">
                                From job post to hire — without the hiring headache.
                            </h1>
                            <p className="mt-4 text-lg text-gray-600">
                                DEVision helps companies manage hiring in one focused workspace.
                                No scattered emails. No lost candidates. Just a clear path from application to offer.
                            </p>
